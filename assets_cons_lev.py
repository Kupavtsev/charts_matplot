...
def update2(frame):
    ...
    data4 = asyncio.run(get_data('LPTUSDT'))

    data5 = asyncio.run(get_data('STORJUSDT'))
    data6 = asyncio.run(get_data('WLDUSDT'))
    data7 = asyncio.run(get_data('AMBUSDT'))
    data8 = asyncio.run(get_data('KNCUSDT'))

    data9 = asyncio.run(get_data('LEVERUSDT'))
    data10 = asyncio.run(get_data('MKRUSDT'))
    data11 = asyncio.run(get_data('PENDLEUSDT'))
    data12 = asyncio.run(get_data('SPELLUSDT'))
